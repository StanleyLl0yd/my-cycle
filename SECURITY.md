...
Never include real cycle history, personal notes, exported CSV files, private keys, API keys, access tokens or other personal data in vulnerability reports, screenshots, logs or test cases.
